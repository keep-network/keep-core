...
each member of the group is punished
by taking away some or all of their staked tokens.
...
include::contract-structure.adoc[leveloffset=+0]

include::authorizations.adoc[leveloffset=+0]

include::upgrades.adoc[leveloffset=+0]
