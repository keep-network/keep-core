...
[source, python]
----
include::dkg.py[lines=47..56]
----

.Utility functions
[source, python]
----
include::dkg_util.py[lines=4..9]
----
...
[source, python]
----
include::dkg.py[lines=63..102]
----

.Utility functions
[source, python]
----
include::dkg_util.py[lines=12..38]
----
...
[source, python]
----
include::dkg.py[lines=109..132]
----

.Utility functions
[source, python]
----
include::dkg_util.py[lines=36..118]
----
...
[source, python]
----
include::dkg.py[lines=139..175]
----

.Utility functions
[source, python]
----
include::dkg_util.py[lines=121..124]
----
...
[source, python]
----
include::dkg.py[lines=223..239]
----

.Utility functions
[source, python]
----
include::dkg_util.py[lines=127..155]
----
...
[source, python]
----
include::dkg.py[lines=246..275]
----

.Utility functions
[source, python]
----
include::dkg_util.py[lines=158..190]
----
...
[source, python]
----
include::dkg.py[lines=295..339]
----

.Utility functions
[source, python]
----
include::dkg_util.py[lines=193..197]
----
...
[source, python]
----
include::dkg.py[lines=346..361]
----

.Utility functions
[source, python]
----
include::dkg_util.py[lines=200..211]
----
...
while resultPublished and not finished:
  ...
  if T_now > T_first + T_conflict or leadResult.votes > M:
    finished = True
