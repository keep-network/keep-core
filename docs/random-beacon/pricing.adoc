...
_actual entry price_ = _callback expenditure_ +  _entry base price_ (_estimated gas price_, _profit margin_, _DKG contribution_, _entry verification fee_)

If no callback was specified in the request the _callback expenditure_ is 0
and:

_actual entry price = entry base price_.
