...
Application configuration can be stored in a `.toml` file and passed to the application
...
|URLRPC
|The Ethereum host your client will connect to.  HTTP protocol/port.
|""
|Yes
|KEEP_ETHEREUM_URLRPC
...
|
|No
|KEEP_ETHEREUM_CONTRACTS_RANDOMBEACON
