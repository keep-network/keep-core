...
decisions and incentives as the protocol (reay operation) level.
...
client is allowed to stay connected. Concretely, this is done through:
  ...
  2. Configuring the max number of connections per host, overall, and other
  ConnState configurations.
