...
- Each beacon client deployment requires a unique operator account.
- Each beacon client deployment requires a unique IP address or a unique application port running
  under the same IP.
