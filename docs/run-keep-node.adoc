...
Metrics are enabled once the client starts. It is possible to customize port at which
...
Diagnostics are enabled once the client starts. It is possible to customize port at which
