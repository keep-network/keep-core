...
To complete this phase, just part of signers is required. The minimum number of signers
...
_Signature Unmask_, _Signature Factor Public Hash_ and encrypted _Secret Key Factor_ 
and _Secret Key Multiple_. +
