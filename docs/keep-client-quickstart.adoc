...
Depending on your deployment conditions it's possible the address registered with the Keep Network
is not publicly accessible.  When this happens peers on the network will not be able to communicate
directly with your nodes.
...
`AnnouncedAddresses` will be part of a multiaddr and should be formatted accordingly. See link:[https://github.com/multiformats/multiaddr]
