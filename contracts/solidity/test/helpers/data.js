export const bls = {
  ...
  // signature of the above groupPubKey using secret key 123 for unauthorized signing tests
  signedGroupPubKey: web3.utils.toBN('78578065066019918715676618742469668905025994910418923882069710934718366752692'),
