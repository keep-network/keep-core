...
contract KeepRandomBeaconFrontendUpgradeExample is KeepRandomBeaconFrontendImplV1 {
     ...
     */
    function initialize(uint256 _minPayment, uint256 withdrawalDelay, address _backendContract, uint256 _relayRequestTimeout)
        public
        onlyOwner
    {
        withdrawalDelay; // Silence unused var
        super.initialize(_minPayment, _withdrawalDelay, _backendContract, _relayRequestTimeout);
