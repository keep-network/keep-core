...
contract KeepRandomBeaconServiceImplV1 is ReentrancyGuard, IRandomBeacon {
    ...
    bytes
        internal constant _beaconSeed = hex"15c30f4b6cf6dbbcbdcc10fe22f54c8170aea44e198139b776d512d8f027319a1b9e8bfaf1383978231ce98e42bafc8129f473fc993cf60ce327f7d223460663";
    ...
    modifier onlyOperatorContractUpgrader() {
        address operatorContractUpgrader = KeepRegistry(_registry)
            .operatorContractUpgraderFor(address(this));
        require(
        ...
        returns (address)
    {
        ...
        address[] memory approvedContracts = new address[](
            _operatorContracts.length
        );
        ...
        returns (uint256)
    {
        ...
        uint256 selectedOperatorContractFee = operatorContract
            .groupProfitFee()
            .add(operatorContract.entryVerificationFee());
        ...
        uint256 surplus = entryVerificationFee.add(groupProfitFee).sub(
    ...
    function createGroupIfApplicable(uint256 entry, address payable submitter)
        internal
    {
        address latestOperatorContract = _operatorContracts[_operatorContracts
            .length
            .sub(1)];
        ...
        returns (uint256)
    {
        ...
        uint256 callbackGas = _callbackGas == 0
            ? 0
            : _callbackGas.add(_baseCallbackGas);
