...
|relayRequestFee
|Fee paid in T by the relay requester
|Yes
d|`200e18` +
`200 T`
...
|Duration of the sortition pool rewards ban imposed on operators who were inactive/disqualified
during off-chain DKG or were voted by the group as notoriously failing heartbeats.
|Yes
|`2 weeks`
