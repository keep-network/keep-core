...
import { blsDeployment } from "./helpers/fixtures";
...
describe("BLS", function () {
  ...
  it("should use reasonable amount of gas", async () => {
    ...
    expect(gasEstimate.toNumber()).to.be.lessThan(306682, "BLS verification is too expensive")
  })
  ...
  it("should be able to sign a message and verify it", async function () {
    const message = "0x4120626561722077616c6b7320696e746f206120626172203132332e2e2e"
