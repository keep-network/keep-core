...
contract StakingStub is IStaking {
    ...
    function increaseAuthorization(
        ...
        require(operatorStakes[operator] >= amount, "Not enough stake");
        operatorAuthorizations[operator][application] = amount;
    ...
    {
        return (operator, payable(operator), operator);
    }
