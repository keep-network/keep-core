...
import "../RandomBeaconGovernance.sol";

/// @title Keep Random Beacon Governance Stub
contract RandomBeaconGovernanceStub is RandomBeaconGovernance {
    constructor(RandomBeacon _randomBeacon, uint256 _governanceDelay)
        RandomBeaconGovernance(_randomBeacon, _governanceDelay)
    {}

    /// @notice Begins the group lifetime update process.
    /// @dev Can be called only by the contract owner.
    /// @param _newGroupLifetime New group lifetime in blocks
    function beginGroupLifetimeUpdateStub(uint256 _newGroupLifetime)
        external
        onlyOwner
    {
