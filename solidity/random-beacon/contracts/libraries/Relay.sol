...
library Relay {
        ...
        returns (bool)
    {
        ...
        // TODO: consider removing isRequestInProgress() and moving upstream to
        // avoid duplication in upstream calls and save gas.
        return
            isRequestInProgress(self) &&
            block.number > self.currentRequestStartBlock + hardTimeout;
    }
        ...
        returns (bool)
    {
        ...
        return
            isRequestInProgress(self) &&
            block.number > self.currentRequestStartBlock + softTimeout;
    }
}
