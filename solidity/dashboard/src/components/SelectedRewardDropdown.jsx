...
const groupPublicKeyStyle = { marginRight: '20px', borderRadius: '100px', padding: '0.1rem' }
  ...
  return (
    <div className="flex row flex-1 wrap space-between center">
      ...
      <div className="bg-grey-10 text-grey-50" style={groupPublicKeyStyle}>
        ...
        <span className="text-smaller">&nbsp;{shortenAddress(groupReward.groupPublicKey)}</span>
      </div>
    </div>
  )
}
