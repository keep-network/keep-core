...
const blsData = {
  ...
  nextNextNextGroupSignature:
    "0x2ed17b6237a4b9b9389f6964c4a07017d8461cb2602c367fbce7f9414585f6fc0ba88e1264f783386fb8493d31d733a100bf21f46acf0b3bf99c89834517907f",

  // uint256(keccak256(groupSignature))
  groupSignatureNumber: web3.utils.toBN(
    "33136845259729814081977577432759716433762925710284529101628804651946005705295"
  ),

  // uint256(keccak256(nextGroupSignature))
  nextGroupSignatureNumber: web3.utils.toBN(
    "63728602218731680462391130646366490115686215934918152495059999747427209618626"
  ),

  // uint256(keccak256(nextNextGroupSignatureNumber))
  nextNextGroupSignatureNumber: web3.utils.toBN(
    "9775714160560684692317854436734528040997044179054191762446020971841873971471"
  ),

  // uint256(keccak256(nextNextNextGroupSignatureNumber))
  nextNextNextGroupSignatureNumber: web3.utils.toBN(
    "76547413554296705539222469062348207443894285352667024772941555864069963020436"
  ),
}
