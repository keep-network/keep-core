...
describe("KeepRegistry", () => {
  ...
  before(async () => {
    ...
    await registry.setDefaultPanicButton(defaultPanicButton, {
      from: governance,
    })
  ...
  describe("setGovernance", async () => {
    ...
    it("emits an event", async () => {
      const receipt = await registry.setGovernance(someoneElse, {
        from: governance,
      })
  ...
  describe("setRegistryKeeper", async () => {
    ...
    it("emits an event", async () => {
      const receipt = await registry.setRegistryKeeper(someoneElse, {
        from: governance,
      })
  ...
  describe("setDefaultPanicButton", async () => {
    ...
    it("emits an event", async () => {
      const receipt = await registry.setDefaultPanicButton(someoneElse, {
        from: governance,
      })
  ...
  describe("setOperatorContractPanicButton", async () => {
    beforeEach(async () => {
      await registry.approveOperatorContract(operatorContract1, {
        from: registryKeeper,
      })
    })
    ...
    it("can not be called on contracts with disabled panic button", async () => {
      await registry.disableOperatorContractPanicButton(operatorContract1, {
        from: governance,
      })
      assert.equal(
  ...
  describe("setOperatorContractUpgrader", async () => {
    ...
    it("can not be called by non-governance", async () => {
      await expectRevert(
        registry.setOperatorContractUpgrader(serviceContract1, someoneElse, {
          from: owner,
        }),
        "Not authorized"
      )
  ...
  describe("approveOperatorContract", async () => {
    ...
    it("can not be called by non-registry-keeper", async () => {
      await expectRevert(
        registry.approveOperatorContract(operatorContract1, { from: owner }),
        "Not authorized"
      )
    })
    ...
    it("cannot be called for already approved contract", async () => {
      ...
      await expectRevert(
        registry.approveOperatorContract(operatorContract1, {
          from: registryKeeper,
        }),
    ...
    it("cannot be called for disabled contract", async () => {
      ...
      await registry.disableOperatorContract(operatorContract1, {
  ...
  describe("disableOperatorContract", async () => {
    ...
    it("cannot be called by default panic button if contract has its own", async () => {
      ...
      await expectRevert(
        registry.disableOperatorContract(operatorContract1, {
          from: defaultPanicButton,
        }),
        "Not authorized"
      )
    ...
    it("can not be called by non-registry-keeper", async () => {
      await expectRevert(
        registry.disableOperatorContract(operatorContract1, { from: owner }),
        "Not authorized"
      )
    })
    ...
    it("cannot be called for new operator contract", async () => {
      await expectRevert(
        registry.disableOperatorContract(operatorContract2, {
          from: defaultPanicButton,
        }),
        "Not an approved operator contract"
      )
