...
// GroupSelectionInterface defines the subset of the TBTC chain interface that
// pertains to the group selection activities.
...
// GroupInterface defines the subset of the TBTC chain interface that pertains
