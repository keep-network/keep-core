// TODO: These functionalities were temporarily moved to the chain package in order
//       to avoid circular dependency between dkg and tbtc. Move it back to tbtc package.
//       Do not use the tbtc package in dkg, use new interfaces (like ResultSubmitter, ResultSigner, etc)
