...
func bindWalletRegistry(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(WalletRegistryABI))
	if err != nil {
		return nil, err
	}
...
//
// Solidity: function dkgParameters() view returns((uint256,uint256,uint256,uint256))
...
// UpdateDkgParameters is a paid mutator transaction binding the contract method 0x93cc51a2.
//
// Solidity: function updateDkgParameters(uint256 _seedTimeout, uint256 _resultChallengePeriodLength, uint256 _resultSubmissionTimeout, uint256 _submitterPrecedencePeriodLength) returns()
func (_WalletRegistry *WalletRegistryTransactor) UpdateDkgParameters(opts *bind.TransactOpts, _seedTimeout *big.Int, _resultChallengePeriodLength *big.Int, _resultSubmissionTimeout *big.Int, _submitterPrecedencePeriodLength *big.Int) (*types.Transaction, error) {
	return _WalletRegistry.contract.Transact(opts, "updateDkgParameters", _seedTimeout, _resultChallengePeriodLength, _resultSubmissionTimeout, _submitterPrecedencePeriodLength)
}

// UpdateDkgParameters is a paid mutator transaction binding the contract method 0x93cc51a2.
//
// Solidity: function updateDkgParameters(uint256 _seedTimeout, uint256 _resultChallengePeriodLength, uint256 _resultSubmissionTimeout, uint256 _submitterPrecedencePeriodLength) returns()
func (_WalletRegistry *WalletRegistrySession) UpdateDkgParameters(_seedTimeout *big.Int, _resultChallengePeriodLength *big.Int, _resultSubmissionTimeout *big.Int, _submitterPrecedencePeriodLength *big.Int) (*types.Transaction, error) {
	return _WalletRegistry.Contract.UpdateDkgParameters(&_WalletRegistry.TransactOpts, _seedTimeout, _resultChallengePeriodLength, _resultSubmissionTimeout, _submitterPrecedencePeriodLength)
}

// UpdateDkgParameters is a paid mutator transaction binding the contract method 0x93cc51a2.
//
// Solidity: function updateDkgParameters(uint256 _seedTimeout, uint256 _resultChallengePeriodLength, uint256 _resultSubmissionTimeout, uint256 _submitterPrecedencePeriodLength) returns()
func (_WalletRegistry *WalletRegistryTransactorSession) UpdateDkgParameters(_seedTimeout *big.Int, _resultChallengePeriodLength *big.Int, _resultSubmissionTimeout *big.Int, _submitterPrecedencePeriodLength *big.Int) (*types.Transaction, error) {
	return _WalletRegistry.Contract.UpdateDkgParameters(&_WalletRegistry.TransactOpts, _seedTimeout, _resultChallengePeriodLength, _resultSubmissionTimeout, _submitterPrecedencePeriodLength)
}
...
// FilterDkgParametersUpdated is a free log retrieval operation binding the contract event 0x0a9dcb046e16a7970be15acb8e74c66378849ae91679b064c77fb1e53768ae47.
//
// Solidity: event DkgParametersUpdated(uint256 seedTimeout, uint256 resultChallengePeriodLength, uint256 resultSubmissionTimeout, uint256 resultSubmitterPrecedencePeriodLength)
...
// WatchDkgParametersUpdated is a free log subscription operation binding the contract event 0x0a9dcb046e16a7970be15acb8e74c66378849ae91679b064c77fb1e53768ae47.
//
// Solidity: event DkgParametersUpdated(uint256 seedTimeout, uint256 resultChallengePeriodLength, uint256 resultSubmissionTimeout, uint256 resultSubmitterPrecedencePeriodLength)
...
// ParseDkgParametersUpdated is a log parse operation binding the contract event 0x0a9dcb046e16a7970be15acb8e74c66378849ae91679b064c77fb1e53768ae47.
//
// Solidity: event DkgParametersUpdated(uint256 seedTimeout, uint256 resultChallengePeriodLength, uint256 resultSubmissionTimeout, uint256 resultSubmitterPrecedencePeriodLength)
