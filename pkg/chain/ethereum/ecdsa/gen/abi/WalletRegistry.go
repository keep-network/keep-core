...
// EcdsaDkgData is an auto generated low-level Go binding around an user-defined struct.
type EcdsaDkgData struct {
	SortitionPool                    common.Address
	DkgValidator                     common.Address
	Parameters                       EcdsaDkgParameters
	StateLockBlock                   *big.Int
	StartBlock                       *big.Int
	Seed                             *big.Int
	ResultSubmissionStartBlockOffset *big.Int
	SubmittedResultHash              [32]byte
	SubmittedResultBlock             *big.Int
	Gap                              [38]*big.Int
}
...
// GetDkgData is a free data retrieval call binding the contract method 0x592b2abd.
//
// Solidity: function getDkgData() view returns((address,address,(uint256,uint256,uint256,uint256,uint256),uint256,uint256,uint256,uint256,bytes32,uint256,uint256[38]))
func (_WalletRegistry *WalletRegistryCaller) GetDkgData(opts *bind.CallOpts) (EcdsaDkgData, error) {
	var out []interface{}
	err := _WalletRegistry.contract.Call(opts, &out, "getDkgData")

	if err != nil {
		return *new(EcdsaDkgData), err
	}

	out0 := *abi.ConvertType(out[0], new(EcdsaDkgData)).(*EcdsaDkgData)
...
//
// Solidity: function getDkgData() view returns((address,address,(uint256,uint256,uint256,uint256,uint256),uint256,uint256,uint256,uint256,bytes32,uint256,uint256[38]))
func (_WalletRegistry *WalletRegistrySession) GetDkgData() (EcdsaDkgData, error) {
	return _WalletRegistry.Contract.GetDkgData(&_WalletRegistry.CallOpts)
}

// GetDkgData is a free data retrieval call binding the contract method 0x592b2abd.
//
// Solidity: function getDkgData() view returns((address,address,(uint256,uint256,uint256,uint256,uint256),uint256,uint256,uint256,uint256,bytes32,uint256,uint256[38]))
func (_WalletRegistry *WalletRegistryCallerSession) GetDkgData() (EcdsaDkgData, error) {
	return _WalletRegistry.Contract.GetDkgData(&_WalletRegistry.CallOpts)
}
...
// ForceAddWallet is a paid mutator transaction binding the contract method 0x2717ee0d.
//
// Solidity: function forceAddWallet(bytes groupPubKey, bytes32 membersIdsHash) returns()
...
//
// Solidity: function forceAddWallet(bytes groupPubKey, bytes32 membersIdsHash) returns()
func (_WalletRegistry *WalletRegistrySession) ForceAddWallet(groupPubKey []byte, membersIdsHash [32]byte) (*types.Transaction, error) {
	return _WalletRegistry.Contract.ForceAddWallet(&_WalletRegistry.TransactOpts, groupPubKey, membersIdsHash)
}

// ForceAddWallet is a paid mutator transaction binding the contract method 0x2717ee0d.
//
// Solidity: function forceAddWallet(bytes groupPubKey, bytes32 membersIdsHash) returns()
func (_WalletRegistry *WalletRegistryTransactorSession) ForceAddWallet(groupPubKey []byte, membersIdsHash [32]byte) (*types.Transaction, error) {
	return _WalletRegistry.Contract.ForceAddWallet(&_WalletRegistry.TransactOpts, groupPubKey, membersIdsHash)
}
