...
func (_Bridge *BridgeCaller) ContractReferences(opts *bind.CallOpts) (struct {
	...
	outstruct.ReimbursementPool = *abi.ConvertType(out[3], new(common.Address)).(*common.Address)
...
func (_Bridge *BridgeCaller) DepositParameters(opts *bind.CallOpts) (struct {
	...
	outstruct.DepositRevealAheadPeriod = *abi.ConvertType(out[3], new(uint32)).(*uint32)
...
func (_Bridge *BridgeCaller) MovingFundsParameters(opts *bind.CallOpts) (struct {
	...
	outstruct.MovingFundsCommitmentGasOffset = *abi.ConvertType(out[6], new(uint16)).(*uint16)
	outstruct.MovedFundsSweepTxMaxTotalFee = *abi.ConvertType(out[7], new(uint64)).(*uint64)
	outstruct.MovedFundsSweepTimeout = *abi.ConvertType(out[8], new(uint32)).(*uint32)
	outstruct.MovedFundsSweepTimeoutSlashingAmount = *abi.ConvertType(out[9], new(*big.Int)).(**big.Int)
	outstruct.MovedFundsSweepTimeoutNotifierRewardMultiplier = *abi.ConvertType(out[10], new(uint32)).(*uint32)
...
func (_Bridge *BridgeCaller) RedemptionParameters(opts *bind.CallOpts) (struct {
	...
	outstruct.RedemptionTxMaxTotalFee = *abi.ConvertType(out[3], new(uint64)).(*uint64)
	outstruct.RedemptionTimeout = *abi.ConvertType(out[4], new(uint32)).(*uint32)
	outstruct.RedemptionTimeoutSlashingAmount = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
	outstruct.RedemptionTimeoutNotifierRewardMultiplier = *abi.ConvertType(out[6], new(uint32)).(*uint32)
...
func (_Bridge *BridgeTransactor) Initialize(opts *bind.TransactOpts, _bank common.Address, _relay common.Address, _treasury common.Address, _ecdsaWalletRegistry common.Address, _reimbursementPool common.Address, _txProofDifficultyFactor *big.Int) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "initialize", _bank, _relay, _treasury, _ecdsaWalletRegistry, _reimbursementPool, _txProofDifficultyFactor)
}
...
// ProcessPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x61879905.
//
// Solidity: function processPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeTransactor) ProcessPendingMovedFundsSweepRequest(opts *bind.TransactOpts, walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "processPendingMovedFundsSweepRequest", walletPubKeyHash, utxo)
}

// ProcessPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x61879905.
//
// Solidity: function processPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeSession) ProcessPendingMovedFundsSweepRequest(walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.ProcessPendingMovedFundsSweepRequest(&_Bridge.TransactOpts, walletPubKeyHash, utxo)
}

// ProcessPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x61879905.
//
// Solidity: function processPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeTransactorSession) ProcessPendingMovedFundsSweepRequest(walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.ProcessPendingMovedFundsSweepRequest(&_Bridge.TransactOpts, walletPubKeyHash, utxo)
}
...
// SetActiveWallet is a paid mutator transaction binding the contract method 0xdf7cd4ae.
//
// Solidity: function setActiveWallet(bytes20 activeWalletPubKeyHash) returns()
func (_Bridge *BridgeTransactor) SetActiveWallet(opts *bind.TransactOpts, activeWalletPubKeyHash [20]byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setActiveWallet", activeWalletPubKeyHash)
}

// SetActiveWallet is a paid mutator transaction binding the contract method 0xdf7cd4ae.
//
// Solidity: function setActiveWallet(bytes20 activeWalletPubKeyHash) returns()
func (_Bridge *BridgeSession) SetActiveWallet(activeWalletPubKeyHash [20]byte) (*types.Transaction, error) {
	return _Bridge.Contract.SetActiveWallet(&_Bridge.TransactOpts, activeWalletPubKeyHash)
}

// SetActiveWallet is a paid mutator transaction binding the contract method 0xdf7cd4ae.
//
// Solidity: function setActiveWallet(bytes20 activeWalletPubKeyHash) returns()
func (_Bridge *BridgeTransactorSession) SetActiveWallet(activeWalletPubKeyHash [20]byte) (*types.Transaction, error) {
	return _Bridge.Contract.SetActiveWallet(&_Bridge.TransactOpts, activeWalletPubKeyHash)
}

// SetDepositDustThreshold is a paid mutator transaction binding the contract method 0x59e6a456.
//
// Solidity: function setDepositDustThreshold(uint64 _depositDustThreshold) returns()
func (_Bridge *BridgeTransactor) SetDepositDustThreshold(opts *bind.TransactOpts, _depositDustThreshold uint64) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setDepositDustThreshold", _depositDustThreshold)
}

// SetDepositDustThreshold is a paid mutator transaction binding the contract method 0x59e6a456.
//
// Solidity: function setDepositDustThreshold(uint64 _depositDustThreshold) returns()
func (_Bridge *BridgeSession) SetDepositDustThreshold(_depositDustThreshold uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetDepositDustThreshold(&_Bridge.TransactOpts, _depositDustThreshold)
}

// SetDepositDustThreshold is a paid mutator transaction binding the contract method 0x59e6a456.
//
// Solidity: function setDepositDustThreshold(uint64 _depositDustThreshold) returns()
func (_Bridge *BridgeTransactorSession) SetDepositDustThreshold(_depositDustThreshold uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetDepositDustThreshold(&_Bridge.TransactOpts, _depositDustThreshold)
}

// SetDepositRevealAheadPeriod is a paid mutator transaction binding the contract method 0x539c6322.
//
// Solidity: function setDepositRevealAheadPeriod(uint32 _depositRevealAheadPeriod) returns()
func (_Bridge *BridgeTransactor) SetDepositRevealAheadPeriod(opts *bind.TransactOpts, _depositRevealAheadPeriod uint32) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setDepositRevealAheadPeriod", _depositRevealAheadPeriod)
}

// SetDepositRevealAheadPeriod is a paid mutator transaction binding the contract method 0x539c6322.
//
// Solidity: function setDepositRevealAheadPeriod(uint32 _depositRevealAheadPeriod) returns()
func (_Bridge *BridgeSession) SetDepositRevealAheadPeriod(_depositRevealAheadPeriod uint32) (*types.Transaction, error) {
	return _Bridge.Contract.SetDepositRevealAheadPeriod(&_Bridge.TransactOpts, _depositRevealAheadPeriod)
}

// SetDepositRevealAheadPeriod is a paid mutator transaction binding the contract method 0x539c6322.
//
// Solidity: function setDepositRevealAheadPeriod(uint32 _depositRevealAheadPeriod) returns()
func (_Bridge *BridgeTransactorSession) SetDepositRevealAheadPeriod(_depositRevealAheadPeriod uint32) (*types.Transaction, error) {
	return _Bridge.Contract.SetDepositRevealAheadPeriod(&_Bridge.TransactOpts, _depositRevealAheadPeriod)
}

// SetDepositTxMaxFee is a paid mutator transaction binding the contract method 0xb036c1ee.
//
// Solidity: function setDepositTxMaxFee(uint64 _depositTxMaxFee) returns()
func (_Bridge *BridgeTransactor) SetDepositTxMaxFee(opts *bind.TransactOpts, _depositTxMaxFee uint64) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setDepositTxMaxFee", _depositTxMaxFee)
}

// SetDepositTxMaxFee is a paid mutator transaction binding the contract method 0xb036c1ee.
//
// Solidity: function setDepositTxMaxFee(uint64 _depositTxMaxFee) returns()
func (_Bridge *BridgeSession) SetDepositTxMaxFee(_depositTxMaxFee uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetDepositTxMaxFee(&_Bridge.TransactOpts, _depositTxMaxFee)
}

// SetDepositTxMaxFee is a paid mutator transaction binding the contract method 0xb036c1ee.
//
// Solidity: function setDepositTxMaxFee(uint64 _depositTxMaxFee) returns()
func (_Bridge *BridgeTransactorSession) SetDepositTxMaxFee(_depositTxMaxFee uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetDepositTxMaxFee(&_Bridge.TransactOpts, _depositTxMaxFee)
}

// SetMovedFundsSweepTxMaxTotalFee is a paid mutator transaction binding the contract method 0xf139b088.
//
// Solidity: function setMovedFundsSweepTxMaxTotalFee(uint64 _movedFundsSweepTxMaxTotalFee) returns()
func (_Bridge *BridgeTransactor) SetMovedFundsSweepTxMaxTotalFee(opts *bind.TransactOpts, _movedFundsSweepTxMaxTotalFee uint64) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setMovedFundsSweepTxMaxTotalFee", _movedFundsSweepTxMaxTotalFee)
}

// SetMovedFundsSweepTxMaxTotalFee is a paid mutator transaction binding the contract method 0xf139b088.
//
// Solidity: function setMovedFundsSweepTxMaxTotalFee(uint64 _movedFundsSweepTxMaxTotalFee) returns()
func (_Bridge *BridgeSession) SetMovedFundsSweepTxMaxTotalFee(_movedFundsSweepTxMaxTotalFee uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetMovedFundsSweepTxMaxTotalFee(&_Bridge.TransactOpts, _movedFundsSweepTxMaxTotalFee)
}

// SetMovedFundsSweepTxMaxTotalFee is a paid mutator transaction binding the contract method 0xf139b088.
//
// Solidity: function setMovedFundsSweepTxMaxTotalFee(uint64 _movedFundsSweepTxMaxTotalFee) returns()
func (_Bridge *BridgeTransactorSession) SetMovedFundsSweepTxMaxTotalFee(_movedFundsSweepTxMaxTotalFee uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetMovedFundsSweepTxMaxTotalFee(&_Bridge.TransactOpts, _movedFundsSweepTxMaxTotalFee)
}

// SetPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x07453444.
//
// Solidity: function setPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeTransactor) SetPendingMovedFundsSweepRequest(opts *bind.TransactOpts, walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setPendingMovedFundsSweepRequest", walletPubKeyHash, utxo)
}

// SetPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x07453444.
//
// Solidity: function setPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeSession) SetPendingMovedFundsSweepRequest(walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetPendingMovedFundsSweepRequest(&_Bridge.TransactOpts, walletPubKeyHash, utxo)
}

// SetPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x07453444.
//
// Solidity: function setPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeTransactorSession) SetPendingMovedFundsSweepRequest(walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetPendingMovedFundsSweepRequest(&_Bridge.TransactOpts, walletPubKeyHash, utxo)
}

// SetProcessedMovedFundsSweepRequests is a paid mutator transaction binding the contract method 0xdccfb3b9.
//
// Solidity: function setProcessedMovedFundsSweepRequests((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeTransactor) SetProcessedMovedFundsSweepRequests(opts *bind.TransactOpts, utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setProcessedMovedFundsSweepRequests", utxos)
}

// SetProcessedMovedFundsSweepRequests is a paid mutator transaction binding the contract method 0xdccfb3b9.
//
// Solidity: function setProcessedMovedFundsSweepRequests((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeSession) SetProcessedMovedFundsSweepRequests(utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetProcessedMovedFundsSweepRequests(&_Bridge.TransactOpts, utxos)
}

// SetProcessedMovedFundsSweepRequests is a paid mutator transaction binding the contract method 0xdccfb3b9.
//
// Solidity: function setProcessedMovedFundsSweepRequests((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeTransactorSession) SetProcessedMovedFundsSweepRequests(utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetProcessedMovedFundsSweepRequests(&_Bridge.TransactOpts, utxos)
}

// SetRedemptionDustThreshold is a paid mutator transaction binding the contract method 0x3c0038f4.
//
// Solidity: function setRedemptionDustThreshold(uint64 _redemptionDustThreshold) returns()
func (_Bridge *BridgeTransactor) SetRedemptionDustThreshold(opts *bind.TransactOpts, _redemptionDustThreshold uint64) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setRedemptionDustThreshold", _redemptionDustThreshold)
}

// SetRedemptionDustThreshold is a paid mutator transaction binding the contract method 0x3c0038f4.
//
// Solidity: function setRedemptionDustThreshold(uint64 _redemptionDustThreshold) returns()
func (_Bridge *BridgeSession) SetRedemptionDustThreshold(_redemptionDustThreshold uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetRedemptionDustThreshold(&_Bridge.TransactOpts, _redemptionDustThreshold)
}

// SetRedemptionDustThreshold is a paid mutator transaction binding the contract method 0x3c0038f4.
//
// Solidity: function setRedemptionDustThreshold(uint64 _redemptionDustThreshold) returns()
func (_Bridge *BridgeTransactorSession) SetRedemptionDustThreshold(_redemptionDustThreshold uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetRedemptionDustThreshold(&_Bridge.TransactOpts, _redemptionDustThreshold)
}

// SetRedemptionTreasuryFeeDivisor is a paid mutator transaction binding the contract method 0x6c854186.
//
// Solidity: function setRedemptionTreasuryFeeDivisor(uint64 _redemptionTreasuryFeeDivisor) returns()
func (_Bridge *BridgeTransactor) SetRedemptionTreasuryFeeDivisor(opts *bind.TransactOpts, _redemptionTreasuryFeeDivisor uint64) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setRedemptionTreasuryFeeDivisor", _redemptionTreasuryFeeDivisor)
}

// SetRedemptionTreasuryFeeDivisor is a paid mutator transaction binding the contract method 0x6c854186.
//
// Solidity: function setRedemptionTreasuryFeeDivisor(uint64 _redemptionTreasuryFeeDivisor) returns()
func (_Bridge *BridgeSession) SetRedemptionTreasuryFeeDivisor(_redemptionTreasuryFeeDivisor uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetRedemptionTreasuryFeeDivisor(&_Bridge.TransactOpts, _redemptionTreasuryFeeDivisor)
}

// SetRedemptionTreasuryFeeDivisor is a paid mutator transaction binding the contract method 0x6c854186.
//
// Solidity: function setRedemptionTreasuryFeeDivisor(uint64 _redemptionTreasuryFeeDivisor) returns()
func (_Bridge *BridgeTransactorSession) SetRedemptionTreasuryFeeDivisor(_redemptionTreasuryFeeDivisor uint64) (*types.Transaction, error) {
	return _Bridge.Contract.SetRedemptionTreasuryFeeDivisor(&_Bridge.TransactOpts, _redemptionTreasuryFeeDivisor)
}

// SetSpentMainUtxos is a paid mutator transaction binding the contract method 0x74babd9c.
//
// Solidity: function setSpentMainUtxos((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeTransactor) SetSpentMainUtxos(opts *bind.TransactOpts, utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setSpentMainUtxos", utxos)
}

// SetSpentMainUtxos is a paid mutator transaction binding the contract method 0x74babd9c.
//
// Solidity: function setSpentMainUtxos((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeSession) SetSpentMainUtxos(utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetSpentMainUtxos(&_Bridge.TransactOpts, utxos)
}

// SetSpentMainUtxos is a paid mutator transaction binding the contract method 0x74babd9c.
//
// Solidity: function setSpentMainUtxos((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeTransactorSession) SetSpentMainUtxos(utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetSpentMainUtxos(&_Bridge.TransactOpts, utxos)
}
...
func (_Bridge *BridgeTransactor) SetSpvMaintainerStatus(opts *bind.TransactOpts, spvMaintainer common.Address, isTrusted bool) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setSpvMaintainerStatus", spvMaintainer, isTrusted)
}
...
func (_Bridge *BridgeSession) SetSpvMaintainerStatus(spvMaintainer common.Address, isTrusted bool) (*types.Transaction, error) {
	return _Bridge.Contract.SetSpvMaintainerStatus(&_Bridge.TransactOpts, spvMaintainer, isTrusted)
}
...
// SetSweptDeposits is a paid mutator transaction binding the contract method 0xb8afb0a5.
//
// Solidity: function setSweptDeposits((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeTransactor) SetSweptDeposits(opts *bind.TransactOpts, utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setSweptDeposits", utxos)
}

// SetSweptDeposits is a paid mutator transaction binding the contract method 0xb8afb0a5.
//
// Solidity: function setSweptDeposits((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeSession) SetSweptDeposits(utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetSweptDeposits(&_Bridge.TransactOpts, utxos)
}

// SetSweptDeposits is a paid mutator transaction binding the contract method 0xb8afb0a5.
//
// Solidity: function setSweptDeposits((bytes32,uint32,uint64)[] utxos) returns()
func (_Bridge *BridgeTransactorSession) SetSweptDeposits(utxos []BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetSweptDeposits(&_Bridge.TransactOpts, utxos)
}
...
// SetWallet is a paid mutator transaction binding the contract method 0xb95b947d.
//
// Solidity: function setWallet(bytes20 walletPubKeyHash, (bytes32,bytes32,uint64,uint32,uint32,uint32,uint32,uint8,bytes32) wallet) returns()
func (_Bridge *BridgeTransactor) SetWallet(opts *bind.TransactOpts, walletPubKeyHash [20]byte, wallet WalletsWallet) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setWallet", walletPubKeyHash, wallet)
}

// SetWallet is a paid mutator transaction binding the contract method 0xb95b947d.
//
// Solidity: function setWallet(bytes20 walletPubKeyHash, (bytes32,bytes32,uint64,uint32,uint32,uint32,uint32,uint8,bytes32) wallet) returns()
func (_Bridge *BridgeSession) SetWallet(walletPubKeyHash [20]byte, wallet WalletsWallet) (*types.Transaction, error) {
	return _Bridge.Contract.SetWallet(&_Bridge.TransactOpts, walletPubKeyHash, wallet)
}

// SetWallet is a paid mutator transaction binding the contract method 0xb95b947d.
//
// Solidity: function setWallet(bytes20 walletPubKeyHash, (bytes32,bytes32,uint64,uint32,uint32,uint32,uint32,uint8,bytes32) wallet) returns()
func (_Bridge *BridgeTransactorSession) SetWallet(walletPubKeyHash [20]byte, wallet WalletsWallet) (*types.Transaction, error) {
	return _Bridge.Contract.SetWallet(&_Bridge.TransactOpts, walletPubKeyHash, wallet)
}

// SetWalletMainUtxo is a paid mutator transaction binding the contract method 0xe404c0a9.
//
// Solidity: function setWalletMainUtxo(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeTransactor) SetWalletMainUtxo(opts *bind.TransactOpts, walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "setWalletMainUtxo", walletPubKeyHash, utxo)
}

// SetWalletMainUtxo is a paid mutator transaction binding the contract method 0xe404c0a9.
//
// Solidity: function setWalletMainUtxo(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeSession) SetWalletMainUtxo(walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetWalletMainUtxo(&_Bridge.TransactOpts, walletPubKeyHash, utxo)
}

// SetWalletMainUtxo is a paid mutator transaction binding the contract method 0xe404c0a9.
//
// Solidity: function setWalletMainUtxo(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeTransactorSession) SetWalletMainUtxo(walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.SetWalletMainUtxo(&_Bridge.TransactOpts, walletPubKeyHash, utxo)
}
...
// TimeoutPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x0bb7a73a.
//
// Solidity: function timeoutPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeTransactor) TimeoutPendingMovedFundsSweepRequest(opts *bind.TransactOpts, walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "timeoutPendingMovedFundsSweepRequest", walletPubKeyHash, utxo)
}

// TimeoutPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x0bb7a73a.
//
// Solidity: function timeoutPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeSession) TimeoutPendingMovedFundsSweepRequest(walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.TimeoutPendingMovedFundsSweepRequest(&_Bridge.TransactOpts, walletPubKeyHash, utxo)
}

// TimeoutPendingMovedFundsSweepRequest is a paid mutator transaction binding the contract method 0x0bb7a73a.
//
// Solidity: function timeoutPendingMovedFundsSweepRequest(bytes20 walletPubKeyHash, (bytes32,uint32,uint64) utxo) returns()
func (_Bridge *BridgeTransactorSession) TimeoutPendingMovedFundsSweepRequest(walletPubKeyHash [20]byte, utxo BitcoinTxUTXO) (*types.Transaction, error) {
	return _Bridge.Contract.TimeoutPendingMovedFundsSweepRequest(&_Bridge.TransactOpts, walletPubKeyHash, utxo)
}
...
func (_Bridge *BridgeTransactor) UpdateDepositParameters(opts *bind.TransactOpts, depositDustThreshold uint64, depositTreasuryFeeDivisor uint64, depositTxMaxFee uint64, depositRevealAheadPeriod uint32) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "updateDepositParameters", depositDustThreshold, depositTreasuryFeeDivisor, depositTxMaxFee, depositRevealAheadPeriod)
}
...
func (_Bridge *BridgeSession) UpdateDepositParameters(depositDustThreshold uint64, depositTreasuryFeeDivisor uint64, depositTxMaxFee uint64, depositRevealAheadPeriod uint32) (*types.Transaction, error) {
	return _Bridge.Contract.UpdateDepositParameters(&_Bridge.TransactOpts, depositDustThreshold, depositTreasuryFeeDivisor, depositTxMaxFee, depositRevealAheadPeriod)
}
...
func (_Bridge *BridgeTransactor) UpdateRedemptionParameters(opts *bind.TransactOpts, redemptionDustThreshold uint64, redemptionTreasuryFeeDivisor uint64, redemptionTxMaxFee uint64, redemptionTxMaxTotalFee uint64, redemptionTimeout uint32, redemptionTimeoutSlashingAmount *big.Int, redemptionTimeoutNotifierRewardMultiplier uint32) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "updateRedemptionParameters", redemptionDustThreshold, redemptionTreasuryFeeDivisor, redemptionTxMaxFee, redemptionTxMaxTotalFee, redemptionTimeout, redemptionTimeoutSlashingAmount, redemptionTimeoutNotifierRewardMultiplier)
}
...
func (_Bridge *BridgeSession) UpdateRedemptionParameters(redemptionDustThreshold uint64, redemptionTreasuryFeeDivisor uint64, redemptionTxMaxFee uint64, redemptionTxMaxTotalFee uint64, redemptionTimeout uint32, redemptionTimeoutSlashingAmount *big.Int, redemptionTimeoutNotifierRewardMultiplier uint32) (*types.Transaction, error) {
	return _Bridge.Contract.UpdateRedemptionParameters(&_Bridge.TransactOpts, redemptionDustThreshold, redemptionTreasuryFeeDivisor, redemptionTxMaxFee, redemptionTxMaxTotalFee, redemptionTimeout, redemptionTimeoutSlashingAmount, redemptionTimeoutNotifierRewardMultiplier)
}
...
func (_Bridge *BridgeTransactor) UpdateTreasury(opts *bind.TransactOpts, treasury common.Address) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "updateTreasury", treasury)
}
...
func (_Bridge *BridgeSession) UpdateTreasury(treasury common.Address) (*types.Transaction, error) {
	return _Bridge.Contract.UpdateTreasury(&_Bridge.TransactOpts, treasury)
}
...
type BridgeSpvMaintainerStatusUpdatedIterator struct {
	Event *BridgeSpvMaintainerStatusUpdated // Event containing the contract specifics and raw log
...
func (it *BridgeSpvMaintainerStatusUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeSpvMaintainerStatusUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type BridgeSpvMaintainerStatusUpdated struct {
...
func (_Bridge *BridgeFilterer) FilterSpvMaintainerStatusUpdated(opts *bind.FilterOpts, spvMaintainer []common.Address) (*BridgeSpvMaintainerStatusUpdatedIterator, error) {
	...
	var spvMaintainerRule []interface{}
	for _, spvMaintainerItem := range spvMaintainer {
		spvMaintainerRule = append(spvMaintainerRule, spvMaintainerItem)
	}

	logs, sub, err := _Bridge.contract.FilterLogs(opts, "SpvMaintainerStatusUpdated", spvMaintainerRule)
	if err != nil {
		return nil, err
	}
	return &BridgeSpvMaintainerStatusUpdatedIterator{contract: _Bridge.contract, event: "SpvMaintainerStatusUpdated", logs: logs, sub: sub}, nil
}
...
func (_Bridge *BridgeFilterer) WatchSpvMaintainerStatusUpdated(opts *bind.WatchOpts, sink chan<- *BridgeSpvMaintainerStatusUpdated, spvMaintainer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Bridge.contract.WatchLogs(opts, "SpvMaintainerStatusUpdated", spvMaintainerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
type BridgeTreasuryUpdatedIterator struct {
	Event *BridgeTreasuryUpdated // Event containing the contract specifics and raw log
...
func (it *BridgeTreasuryUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeTreasuryUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type BridgeTreasuryUpdated struct {
...
func (_Bridge *BridgeFilterer) FilterTreasuryUpdated(opts *bind.FilterOpts) (*BridgeTreasuryUpdatedIterator, error) {
	...
	logs, sub, err := _Bridge.contract.FilterLogs(opts, "TreasuryUpdated")
	if err != nil {
		return nil, err
	}
	return &BridgeTreasuryUpdatedIterator{contract: _Bridge.contract, event: "TreasuryUpdated", logs: logs, sub: sub}, nil
}
...
func (_Bridge *BridgeFilterer) WatchTreasuryUpdated(opts *bind.WatchOpts, sink chan<- *BridgeTreasuryUpdated) (event.Subscription, error) {
	...
	logs, sub, err := _Bridge.contract.WatchLogs(opts, "TreasuryUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeTreasuryUpdated)
				if err := _Bridge.contract.UnpackLog(event, "TreasuryUpdated", log); err != nil {
					return err
				}
				event.Raw = log
