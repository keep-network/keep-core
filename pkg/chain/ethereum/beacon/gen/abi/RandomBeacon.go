...
func bindRandomBeacon(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(RandomBeaconABI))
	if err != nil {
		return nil, err
	}
...
// GenesisSeed is a free data retrieval call binding the contract method 0xdf9386ed.
//
// Solidity: function genesisSeed() view returns(uint256)
func (_RandomBeacon *RandomBeaconCaller) GenesisSeed(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _RandomBeacon.contract.Call(opts, &out, "genesisSeed")
...
//
// Solidity: function genesisSeed() view returns(uint256)
func (_RandomBeacon *RandomBeaconSession) GenesisSeed() (*big.Int, error) {
	return _RandomBeacon.Contract.GenesisSeed(&_RandomBeacon.CallOpts)
}

// GenesisSeed is a free data retrieval call binding the contract method 0xdf9386ed.
//
// Solidity: function genesisSeed() view returns(uint256)
func (_RandomBeacon *RandomBeaconCallerSession) GenesisSeed() (*big.Int, error) {
	return _RandomBeacon.Contract.GenesisSeed(&_RandomBeacon.CallOpts)
}
...
//
// Solidity: function groupCreationParameters() view returns(uint256 groupCreationFrequency, uint256 groupLifetime, uint256 dkgResultChallengePeriodLength, uint256 dkgResultSubmissionTimeout, uint256 dkgSubmitterPrecedencePeriodLength)
func (_RandomBeacon *RandomBeaconCaller) GroupCreationParameters(opts *bind.CallOpts) (struct {
	...
	outstruct.DkgResultSubmissionTimeout = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
	outstruct.DkgSubmitterPrecedencePeriodLength = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
...
// UpdateGroupCreationParameters is a paid mutator transaction binding the contract method 0x0ad6c983.
//
// Solidity: function updateGroupCreationParameters(uint256 groupCreationFrequency, uint256 groupLifetime, uint256 dkgResultChallengePeriodLength, uint256 dkgResultSubmissionTimeout, uint256 dkgSubmitterPrecedencePeriodLength) returns()
func (_RandomBeacon *RandomBeaconTransactor) UpdateGroupCreationParameters(opts *bind.TransactOpts, groupCreationFrequency *big.Int, groupLifetime *big.Int, dkgResultChallengePeriodLength *big.Int, dkgResultSubmissionTimeout *big.Int, dkgSubmitterPrecedencePeriodLength *big.Int) (*types.Transaction, error) {
	return _RandomBeacon.contract.Transact(opts, "updateGroupCreationParameters", groupCreationFrequency, groupLifetime, dkgResultChallengePeriodLength, dkgResultSubmissionTimeout, dkgSubmitterPrecedencePeriodLength)
}

// UpdateGroupCreationParameters is a paid mutator transaction binding the contract method 0x0ad6c983.
//
// Solidity: function updateGroupCreationParameters(uint256 groupCreationFrequency, uint256 groupLifetime, uint256 dkgResultChallengePeriodLength, uint256 dkgResultSubmissionTimeout, uint256 dkgSubmitterPrecedencePeriodLength) returns()
func (_RandomBeacon *RandomBeaconSession) UpdateGroupCreationParameters(groupCreationFrequency *big.Int, groupLifetime *big.Int, dkgResultChallengePeriodLength *big.Int, dkgResultSubmissionTimeout *big.Int, dkgSubmitterPrecedencePeriodLength *big.Int) (*types.Transaction, error) {
	return _RandomBeacon.Contract.UpdateGroupCreationParameters(&_RandomBeacon.TransactOpts, groupCreationFrequency, groupLifetime, dkgResultChallengePeriodLength, dkgResultSubmissionTimeout, dkgSubmitterPrecedencePeriodLength)
}

// UpdateGroupCreationParameters is a paid mutator transaction binding the contract method 0x0ad6c983.
//
// Solidity: function updateGroupCreationParameters(uint256 groupCreationFrequency, uint256 groupLifetime, uint256 dkgResultChallengePeriodLength, uint256 dkgResultSubmissionTimeout, uint256 dkgSubmitterPrecedencePeriodLength) returns()
func (_RandomBeacon *RandomBeaconTransactorSession) UpdateGroupCreationParameters(groupCreationFrequency *big.Int, groupLifetime *big.Int, dkgResultChallengePeriodLength *big.Int, dkgResultSubmissionTimeout *big.Int, dkgSubmitterPrecedencePeriodLength *big.Int) (*types.Transaction, error) {
	return _RandomBeacon.Contract.UpdateGroupCreationParameters(&_RandomBeacon.TransactOpts, groupCreationFrequency, groupLifetime, dkgResultChallengePeriodLength, dkgResultSubmissionTimeout, dkgSubmitterPrecedencePeriodLength)
}
...
// FilterGroupCreationParametersUpdated is a free log retrieval operation binding the contract event 0xa59e1d626cdd9c9ec35488565f3e93b34b13f1aa50a9a054ebea80df00014753.
//
// Solidity: event GroupCreationParametersUpdated(uint256 groupCreationFrequency, uint256 groupLifetime, uint256 dkgResultChallengePeriodLength, uint256 dkgResultSubmissionTimeout, uint256 dkgResultSubmitterPrecedencePeriodLength)
...
// WatchGroupCreationParametersUpdated is a free log subscription operation binding the contract event 0xa59e1d626cdd9c9ec35488565f3e93b34b13f1aa50a9a054ebea80df00014753.
//
// Solidity: event GroupCreationParametersUpdated(uint256 groupCreationFrequency, uint256 groupLifetime, uint256 dkgResultChallengePeriodLength, uint256 dkgResultSubmissionTimeout, uint256 dkgResultSubmitterPrecedencePeriodLength)
...
// ParseGroupCreationParametersUpdated is a log parse operation binding the contract event 0xa59e1d626cdd9c9ec35488565f3e93b34b13f1aa50a9a054ebea80df00014753.
//
// Solidity: event GroupCreationParametersUpdated(uint256 groupCreationFrequency, uint256 groupLifetime, uint256 dkgResultChallengePeriodLength, uint256 dkgResultSubmissionTimeout, uint256 dkgResultSubmitterPrecedencePeriodLength)
