...
func (krbo *KeepRandomBeaconOperator) GetGroupMemberIndices(
	groupPubKey []uint8,
	member common.Address,
) ([]*big.Int, error) {
	var result []*big.Int
	result, err := krbo.contract.GetGroupMemberIndices(
		krbo.callerOptions,
		groupPubKey,
		member,
	)
...
func (krbo *KeepRandomBeaconOperator) GetGroupMemberIndicesAtBlock(
	groupPubKey []uint8,
	member common.Address,
	blockNumber *big.Int,
) ([]*big.Int, error) {
