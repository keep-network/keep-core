...
func (_TokenStaking *TokenStakingCaller) MagpieOf(opts *bind.CallOpts, _operator common.Address) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _TokenStaking.contract.Call(opts, out, "magpieOf", _operator)
	return *ret0, err
}
...
//
// Solidity: function magpieOf(address _operator) constant returns(address)
func (_TokenStaking *TokenStakingSession) MagpieOf(_operator common.Address) (common.Address, error) {
	return _TokenStaking.Contract.MagpieOf(&_TokenStaking.CallOpts, _operator)
}

// MagpieOf is a free data retrieval call binding the contract method 0x1cdac873.
//
// Solidity: function magpieOf(address _operator) constant returns(address)
func (_TokenStaking *TokenStakingCallerSession) MagpieOf(_operator common.Address) (common.Address, error) {
	return _TokenStaking.Contract.MagpieOf(&_TokenStaking.CallOpts, _operator)
}
