...
// KeepTokenMetaData contains all meta data concerning the KeepToken contract.
var KeepTokenMetaData = &bind.MetaData{
...
// Deprecated: Use KeepTokenMetaData.ABI instead.
var KeepTokenABI = KeepTokenMetaData.ABI
