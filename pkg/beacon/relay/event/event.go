...
// PublishedResult represents a result published to the chain.
type PublishedResult struct {
	// Result type of the DKG protocol execution.
	Success bool
	// Group public key generated by DKG protocol execution.
	GroupPublicKey *big.Int
	// Disqualified members array. True value for a given index means that a
	// group member matching the index was disqualified.
	Disqualified []bool
	// Inactive members array. True value for a given index means that a
	// group member matching the index was inactive.
	Inactive []bool
}
