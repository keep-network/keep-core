...
func TestSignAndComplete(t *testing.T) {
	...
	privateKeySharesMap := map[member.MemberIndex]string{
		member.MemberIndex(1): "+20447821705176695776117400920440893381372259028396365458583014272617533574429",
		member.MemberIndex(2): "+10311498259490277582707403215942210669382166384656845373229012913757750213620",
		member.MemberIndex(3): "+12931471259504366138666739996593106353126621511383680527266384358924878290714",
		member.MemberIndex(4): "+6419497833379686221749005517136305344057260008160836576996924421543109310094",
		member.MemberIndex(5): "+12663820852955513054200605522829082730722446275404347866118837288188251767377",
		member.MemberIndex(6): "+9776197446392571413775134268414163424573815912698180050933918772284497166946",
	}
