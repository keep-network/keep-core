...
func (ts testState1) MemberIndex() member.MemberIndex { return ts.memberIndex }
...
func (ts testState2) MemberIndex() member.MemberIndex { return ts.memberIndex }
...
func (ts testState3) MemberIndex() member.MemberIndex { return ts.memberIndex }
...
func (ts testState4) MemberIndex() member.MemberIndex { return ts.memberIndex }
