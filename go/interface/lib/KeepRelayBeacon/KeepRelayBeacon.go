...
// RelayEntryAccusation is a paid mutator transaction binding the contract method 0x1ac6eb77.
//
// Solidity: function relayEntryAccusation(_LastValidRelayTxHash uint256, _LastValidRelayBlock uint256) returns()
func (_KeepRelayBeacon *KeepRelayBeaconTransactor) RelayEntryAccusation(opts *bind.TransactOpts, _LastValidRelayTxHash *big.Int, _LastValidRelayBlock *big.Int) (*types.Transaction, error) {
	return _KeepRelayBeacon.contract.Transact(opts, "relayEntryAccusation", _LastValidRelayTxHash, _LastValidRelayBlock)
}

// RelayEntryAccusation is a paid mutator transaction binding the contract method 0x1ac6eb77.
//
// Solidity: function relayEntryAccusation(_LastValidRelayTxHash uint256, _LastValidRelayBlock uint256) returns()
func (_KeepRelayBeacon *KeepRelayBeaconSession) RelayEntryAccusation(_LastValidRelayTxHash *big.Int, _LastValidRelayBlock *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function relayEntryAccusation(_LastValidRelayTxHash uint256, _LastValidRelayBlock uint256) returns()
func (_KeepRelayBeacon *KeepRelayBeaconTransactorSession) RelayEntryAccusation(_LastValidRelayTxHash *big.Int, _LastValidRelayBlock *big.Int) (*types.Transaction, error) {
	return _KeepRelayBeacon.Contract.RelayEntryAccusation(&_KeepRelayBeacon.TransactOpts, _LastValidRelayTxHash, _LastValidRelayBlock)
}
