...
In addition to the aforementioned capabilities, our protocol should provide
integrity, attributability, and (optionally) confidentiality.
...
In addition to the capabilities, authentication and authorization, along with the
properties, integrity, attributability, and confidentiality, the protocol must be
above all, secure.
